...
class BalanceAndHistoryE2ETest(BaseE2ETest):
    def setUp(self):
        super().setUp()
        # Aluno ja cadastrado e com historico: 1 recarga e 1 refeicao
    ...
    def test_aluno_consulta_saldo_e_historico(self):
        ...
        # 1) Aluno faz login na area de consulta
        ...
        # 2) Nome e saldo atual (50,00 - 5,60 = 44,40) aparecem na tela
        self.wait.until(
            EC.text_to_be_present_in_element((By.CSS_SELECTOR, 'body'), 'Historico E2E')
        )
        self.assertIn('44,40', driver.page_source)  # Saldo calculado e exibido

        # 3) O extrato lista tanto a recarga quanto a refeicao (US4)
